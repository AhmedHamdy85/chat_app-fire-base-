import 'package:chat/features/log_in_feature/presentation/views/widgets/defolt_button.dart';
import 'package:chat/features/log_in_feature/presentation/views/widgets/defolt_text_button.dart';
import 'package:chat/features/log_in_feature/presentation/views/widgets/defolt_text_field.dart';
          ...
          children: [
            ...
            const Row(
              ...
              children: [
                ...
                DefoltTextButton(text: 'Regster Now')
              ],
            )
          ],
        ),
